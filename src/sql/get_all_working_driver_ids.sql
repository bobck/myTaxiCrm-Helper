with working_drivers as (SELECT d.id as driver_id,d.auto_park_id from drivers d WHERE d.inner_status = 'WORKING'AND d.company_id ='4ea03592-9278-4ede-adf8-f7345a856893' AND d.id != ALL($1) ),
