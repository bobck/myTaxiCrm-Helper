...
export async function moveReferralToClosed() {
    ...
    const { finishedRefferals } = await getFinishedRefferals({ procentageRewardAutoParkIds });
...
export async function moveReferralProcentageRewardToClosed() {
    ...
    const { finishedRefferalsProcentageReward } = await getFinishedRefferalsProcentageReward({ procentageRewardAutoParkIds });
