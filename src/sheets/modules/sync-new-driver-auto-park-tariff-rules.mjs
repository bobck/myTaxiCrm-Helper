...
import { getAutoParksToSetTariffRules, getNewDriverTariffRulesByAutoParkSheetName } from "../sheets.utils.mjs";
...
export const synchronizeNewDriverAutoParkTariffRules = async () => {
    ...
    const verifiedAutoParks = autoParks.filter(autoPark => isUuid(autoPark.auto_park_id));
