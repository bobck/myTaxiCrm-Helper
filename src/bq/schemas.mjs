...
export const ordersV2TableSchema = [
  { name: 'id', type: 'INTEGER', mode: 'REQUIRED' },
  { name: 'number', type: 'STRING', mode: 'NULLABLE' },
  { name: 'status_id', type: 'INTEGER', mode: 'NULLABLE' },
  { name: 'status_name', type: 'STRING', mode: 'NULLABLE' },
  { name: 'status_overdue', type: 'BOOLEAN', mode: 'NULLABLE' },
  { name: 'created_at', type: 'INTEGER', mode: 'NULLABLE' },
  { name: 'created_by_id', type: 'INTEGER', mode: 'NULLABLE' },
  { name: 'modified_at', type: 'INTEGER', mode: 'NULLABLE' },
  { name: 'done_at', type: 'INTEGER', mode: 'NULLABLE' },
  { name: 'closed_at', type: 'INTEGER', mode: 'NULLABLE' },
  { name: 'closed_by_id', type: 'INTEGER', mode: 'NULLABLE' },
  { name: 'branch_id', type: 'INTEGER', mode: 'NULLABLE' },
  { name: 'order_type_id', type: 'INTEGER', mode: 'NULLABLE' },
  { name: 'order_type_name', type: 'STRING', mode: 'NULLABLE' },
  { name: 'manager_id', type: 'INTEGER', mode: 'NULLABLE' },
  { name: 'assignee_id', type: 'INTEGER', mode: 'NULLABLE' },
  { name: 'asset_id', type: 'INTEGER', mode: 'NULLABLE' },
  { name: 'asset_uid', type: 'STRING', mode: 'NULLABLE' },
  { name: 'asset_brand', type: 'STRING', mode: 'NULLABLE' },
  { name: 'asset_model', type: 'STRING', mode: 'NULLABLE' },
  { name: 'asset_year', type: 'STRING', mode: 'NULLABLE' },
  { name: 'client_id', type: 'INTEGER', mode: 'NULLABLE' },
  { name: 'client_name', type: 'STRING', mode: 'NULLABLE' },
  { name: 'client_is_organization', type: 'BOOLEAN', mode: 'NULLABLE' },
  { name: 'payer_id', type: 'INTEGER', mode: 'NULLABLE' },
  { name: 'payer_name', type: 'STRING', mode: 'NULLABLE' },
  { name: 'scheduled_for', type: 'INTEGER', mode: 'NULLABLE' },
  { name: 'scheduled_to', type: 'INTEGER', mode: 'NULLABLE' },
  ...
  { name: 'resume', type: 'STRING', mode: 'NULLABLE' },
  { name: 'estimated_price', type: 'FLOAT', mode: 'NULLABLE' },
...
export const orderItemsTableSchema = [
  ...
  { name: 'entity_title', type: 'STRING', mode: 'NULLABLE' },
  { name: 'entity_code', type: 'STRING', mode: 'NULLABLE' },
  { name: 'entity_sku', type: 'STRING', mode: 'NULLABLE' },
  { name: 'entity_description', type: 'STRING', mode: 'NULLABLE' },
  { name: 'entity_sn_accounting', type: 'BOOLEAN', mode: 'NULLABLE' },
  { name: 'entity_is_hidden', type: 'BOOLEAN', mode: 'NULLABLE' },
  { name: 'uom_id', type: 'INTEGER', mode: 'NULLABLE' },
  ...
  { name: 'price', type: 'FLOAT', mode: 'NULLABLE' },
  { name: 'cost', type: 'FLOAT', mode: 'NULLABLE' },
  { name: 'margin_id', type: 'INTEGER', mode: 'NULLABLE' },
  { name: 'is_deduction_required', type: 'BOOLEAN', mode: 'NULLABLE' },
